...
for zavodnik in zavodnici:
    oficialni_cas = zavodnik['casy']['oficialni']
...
with open('words.txt', mode='r', encoding='utf-8') as file:
    for word in file:
        ...
        if first_letter in result:
            # Nejaka slova uz pro dane pismenko ve slovniku mam
            result[first_letter].append(word)
        else:
            # Zadne slovo jeste timto pismenkem nezacinalo
            result[first_letter] = [word]

# Razeni listu u daneho pismenka
